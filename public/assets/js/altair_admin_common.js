...
// 3. Common functions & variables
    ...
    altair_md = {
        ...
        fab_speed_dial: function() {
            $('.md-fab-speed-dial')
                .children('.md-fab')
                .append('<i class="material-icons md-fab-action-close md-color-white" style="display:none">&#xE5CD;</i>')
                .on('click',function() {
                    var $this = $(this),
                ...
                .on('click',function() {
                    ...
                    //Altered by abhinava dinesh to switch the icon on clicking the child element
                    $(this).closest('.md-fab-wrapper').children('.md-fab').velocity({
                        scale: 0
                    },{
                        duration: 140,
                        easing: easing_swiftOut,
            ...
            if($fab_sheet) {
                ...
                $document.on('click scroll', function(e) {
                    if( $fab_sheet.hasClass('md-fab-active') ) {
                        //Code modified by abhinava dinesh to close on clicking options
